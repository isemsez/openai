...
from_file_en = os.path.join(doc_path, r'marketcap_modified.txt')
from_file_ru = os.path.join(doc_path, r'marketcap_gpt_Russian.txt')
save_file = os.path.join(doc_path, r'orig_marketcap_en_ru.txt')
...
print('all lines en: ' + str(len(all_lines_ru)))
